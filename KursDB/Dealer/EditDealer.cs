...
namespace KursDB
{
    public partial class EditDealer : Form
    {
        public Int32 pid;
        public EditDealer(Int32 id, String address, String director, String accounter, String phone, String bank)
        {
            InitializeComponent();
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("UPDATE dealer SET dealer_address = @address, dealer_directoor = @director, dealer_accounter = @accounter, dealer_phone = @phone, dealer_bank_account = @bank WHERE dealer_id = @pId", bd.getConnection());
